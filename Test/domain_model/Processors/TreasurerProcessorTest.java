...
class TreasurerProcessorTest {
    ...
    void getExpectedIncomeOfFiveMembers() {
        ...
        //ARRANGE
        Member user1 = new Member(1, "Malthe", "Tiufkær", true, true, "29/09/1990", false);
        Member user2 = new Member(2, "Oscars", "Bøfsandwich", true, true, "29/09/1990", false);
    ...
    void geMembersInArrears() {
        ...
        Member user1 = new Member(1, "Malthe", "Tiufkær", true, true, "29/09/1990", true);
        Member user2 = new Member(2, "Oscars", "Bøfsandwich", true, true, "29/09/1990", false);
